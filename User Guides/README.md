...
* [Online Conversion Rate](https://github.com/inncee/docs/tree/master/User%20Guides#conversion-rate) - Measures the % of visitors that visited this product page and were converted into customers.
* [Pageviews](https://github.com/inncee/docs/tree/master/User%20Guides#product-pageviews) - Total number of times the product page was viewed by visitors.
...
* [Units Sold](https://github.com/inncee/docs/tree/master/User%20Guides#units-sold) - The units sold metric shows the total units of inventory sold for the selected product
...
* Sales by Channel - The Sales by Channel panel shows the breakdown of the various traffic sources that a product sale was converted from. 
* Sales by Variant - The Sales by Variant panel shows the breakdown of the product sales by its variants. This panel only appears if "All Variants" has been selected in the variant dropdown list near the top of the dashboard

**Reports**

* Orders - Displays a list of all the orders that contained the selected product
* Customers - Display a list of all the customers that had ordered the selected product
...
* Category Conversion Rate - Category conversion rate measures the % of visitors that visited a category page and was converted into a customer
* Added to Cart - 
* Category Pageviews
* Visitors
* Product Sales
...
### Brands
The brands dashboard will show a list of all the brands in your online store and how the products under it has been performing. 
...
The sales metric that is displayed on the Products, Categories or Brands dashboards are calcuated by taking the (Product Price - Product Discount) * Quantity. Order level discounts and returns are excluded by default. Cancelled, unpaid and pending orders are included.
